...
export const projectsData: ProjectFull[] = [
  ...
  },
  {
    ...
    shortDescription:
      'Aplicación web construida desde cero para gestión y difusión de catálogo discográfico. Next.js 16 + Sanity CMS con next/image para portadas optimizadas, Lighthouse CI para Core Web Vitals, Playwright E2E y Sentry para monitoreo.',
    fullDescription:
      'Plataforma web construida desde cero para Decadencia Corporal, discográfica independiente con catálogo navegable y gestión de contenido dinámica (Next.js 16 + Sanity CMS headless). La URL definitiva será decadenciacorporal.com. Problema: necesitaban una presencia digital profesional con buen SEO, imágenes de portadas optimizadas y gestión de contenido sin depender de un desarrollador para cada cambio. Solución: Next.js 16 App Router con Sanity como CMS headless, next/image para servir portadas en formatos modernos con tamaños responsivos, Lighthouse CI para monitoreo de Core Web Vitals (LCP, CLS, INP), y Sentry para tracking de errores en producción. Testing: Jest para unitarios, Playwright para E2E, bundle budget checker. Resultado: catálogo navegable, editable desde Sanity, con métricas de rendimiento verificadas.',
    complexity: 8,
    innovation: 7,
    impact: 8,
