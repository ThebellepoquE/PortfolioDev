...
Ya han pasado unos meses desde que os conté cómo nació **LightON**. Si en el primer post hablábamos de ese "salto al vacío" y la entrega del proyecto final, hoy quiero contaros cómo ese código de "estudiante" se ha ido transformando en una infraestructura sólida, escalable y, sobre todo, profesional.
...
## Diciembre: Refactorizar para no morir
...
## Enero: Más allá de la web (Hola, Automatización)

En Enero me di cuenta de una necesidad real: la reputación online. Un negocio local vive de las reseñas de Google, pero ¿cómo pedir feedback sin ser pesado?

Aquí es donde entró mi pasión por las automatizaciones. Desarrollé un **sistema de encuestas en Python** que:
...
## Febrero: El mes del "Blindaje" Técnico

Este último mes ha sido una locura de aprendizaje intenso. Me puse una meta: llevar LightON al siguiente nivel de calidad. ¿Cómo lo hice?
...
2.  **Dockerización:** Enncapsular todo el ecosistema (Frontend, Backend, Base de Datos Postgres) en contenedores Docker. Ahora desplegar en producción o montar el entorno local es cuestión de segundos.
...
4.  **Seguridad y Logs:** Implementación de un sistema de logging profesional con Winston. Si algo falla en el servidor, ahora sé exactamente qué, cuándo y por qué.
...
LightON ya no es solo "mi proyecto de graduación". Es una herramienta de trabajo real que sigue brillando cada día más. 
