...
Eso funciona cuando tu portfolio tiene tres páginas y dos proyectos. Pero el mío creció sin pedirme permiso, y aunque yo tengo la filosofía de aprender algo cada día — eso no se negocia —, lo que aprendí esta vez es que la intuición sola no alcanza. Que se necesita metodología. Y esa metodología no la inventé yo: me la encontré en el trabajo de Alan Buscaglia, con su herramienta Gentle-AI, que es la que organiza el camino.
